...
import com.clarivate.woslite.auth.Authentication;
import com.clarivate.woslite.auth.HttpBasicAuth;
import okhttp3.*;
...
public class ApiClient {
    ...
    private String basePath = "https://api.clarivate.com/api/woslite";
    ...
    public ApiClient() {
        ...
        authentications.put("key", new ApiKeyAuth("header", "X-ApiKey"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.clarivate.com/api/woslite
